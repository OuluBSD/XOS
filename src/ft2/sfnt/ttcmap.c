...
#define TT_NEXT_ULONG   FT_NEXT_ULONG
  ...
  TT_CMap_ClassRec  tt_cmap0_class_rec =
  {
    {
      sizeof ( TT_CMapRec ),
  ...
  FT_CALLBACK_TABLE_DEF
  TT_CMap_ClassRec  tt_cmap2_class_rec =
  {
    {
      sizeof ( TT_CMapRec ),
  ...
  FT_CALLBACK_TABLE_DEF
  TT_CMap_ClassRec  tt_cmap4_class_rec =
  {
    {
      sizeof ( TT_CMap4Rec ),
  ...
  FT_CALLBACK_TABLE_DEF
  TT_CMap_ClassRec  tt_cmap6_class_rec =
  {
    {
      sizeof ( TT_CMapRec ),
  ...
  FT_CALLBACK_TABLE_DEF
  TT_CMap_ClassRec  tt_cmap8_class_rec =
  {
    {
      sizeof ( TT_CMapRec ),
  ...
  FT_CALLBACK_TABLE_DEF
  TT_CMap_ClassRec  tt_cmap10_class_rec =
  {
    {
      sizeof ( TT_CMapRec ),
  ...
  FT_CALLBACK_TABLE_DEF
  TT_CMap_ClassRec  tt_cmap12_class_rec =
  {
    {
      sizeof ( TT_CMap12Rec ),
